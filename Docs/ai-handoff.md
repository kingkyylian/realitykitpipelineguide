...
| Game Factory CLI | First batch active | `src/rkg/cli.py`, `Tools/rkg.py`, `Docs/game-factory.md`, `Docs/game-spec.md`, `Tests/test_rkg_spec.py`, `Tests/test_rkg_init_game.py`, `Tests/test_rkg_score_idea.py`; `score-idea` and `init-game` are the first RKG surfaces |
