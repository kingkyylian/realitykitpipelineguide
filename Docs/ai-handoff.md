...
3. If deliberately continuing RKG, build Sprint 116 as a racing runtime adapter: vehicle movement, chase camera entity binding from `CameraRig.transform`, lap/checkpoint state, collision/result proof, and screenshot states that visibly differ; do not repeat the already-captured fighter screenshot task.
