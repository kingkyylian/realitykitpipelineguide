...
| No working Blender, but `usdzip` exists | Draft fallback path | Prompt-backed procedural USDZ drafts when Blender crashes before export. | Do not mark imported until RealityKit screenshot evidence exists. |
