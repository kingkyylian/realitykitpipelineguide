...
2. Continue defining reusable generated Swift modules for start, core action, feedback, and fail/miss behavior.
3. Add a screenshot capture command that can consume `Docs/store/screenshot-qa.md` after simulator automation exists.
