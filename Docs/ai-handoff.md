...
2. Bind `stack_puzzle` SwiftUI state into RealityKit scene entity movement.
3. Extract duplicated state-bound scene-controller entity wiring across `lane_dodger`, `toss_physics`, and `wave_defense_lite`.
