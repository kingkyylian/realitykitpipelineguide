...
3. If deliberately continuing RKG, use `Docs/rkg-shard-volley-dogfood.md` as the current gap list. The next useful slice is adapter-specific `qa-plan` proof text plus visual screenshot QA, not another broad adapter rewrite.
