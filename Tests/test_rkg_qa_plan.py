...
class RkgQaPlanTests(unittest.TestCase):
    ...
    def test_custom_projectile_qa_plan_uses_adapter_specific_proof_and_launch_automation(self) -> None:
        ...
        self.assertEqual(payload["steps"][0]["semantic_visual_contract"]["bottom_band_fraction"], 0.2)
        self.assertEqual(payload["steps"][3]["semantic_visual_contract"]["max_center_light_coverage"], 1.0)
