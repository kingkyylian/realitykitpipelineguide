...
class RkgNewGameTests(unittest.TestCase):
    ...
    def test_new_game_writes_racing_realitykit_skeleton_spec(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(spec["quality"]["feel"]["movement"], "momentum")
            self.assertEqual(spec["quality"]["feel"]["input_response"], "responsive")
            self.assertEqual(spec["quality"]["feedback"]["hit"], ["impact_flash", "camera_kick", "haptic_hook"])
            self.assertEqual(spec["quality"]["style"]["shape_language"], "bold_vehicle_readability")
    ...
    def test_new_game_writes_fps_shooter_realitykit_skeleton_spec(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(spec["quality"]["feel"]["movement"], "tactical")
            self.assertEqual(spec["quality"]["feedback"]["hit"], ["muzzle_flash", "hit_spark", "haptic_hook"])
            self.assertEqual(spec["quality"]["style"]["mood"], "focused_combat")
    ...
    def test_new_game_writes_projectile_realitykit_skeleton_spec(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(spec["quality"]["feel"]["movement"], "anchored")
            self.assertEqual(spec["quality"]["feel"]["input_response"], "charged_release")
            self.assertEqual(spec["quality"]["feedback"]["score"], ["score_pop", "lane_clear_chime"])
            self.assertEqual(spec["quality"]["style"]["palette"], "high_contrast_targets")
    ...
    def test_new_game_writes_collector_score_timer_realitykit_skeleton_spec(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(spec["quality"]["feel"]["movement"], "nimble")
            self.assertEqual(spec["quality"]["feel"]["difficulty_curve"], "timer_ramp")
            self.assertEqual(spec["quality"]["feedback"]["hit"], ["pickup_burst", "combo_tick", "haptic_hook"])
            self.assertEqual(spec["quality"]["style"]["shape_language"], "clean_pickup_silhouettes")
